...
/*localStorage.removeItem("productos1")*/
...
function agregarAlCarrito(e) {
    ...
    /*productos = JSON.parse(localStorage.getItem("productos1"))*/
    ...
    if ((cantidadSeleccionada > 0) && (cantidadSeleccionada <= productoBuscado.stock)) {
        ...
        /* console.log(productoBuscado.stock)*/

        actualizaLs("carrito1", arrCarrito)

        /* actualizaLsCarrito(arrCarrito)*/

        actualizaLs("productos1", productos)

        /* actualizaLsProductos(productos)*/
...
function renderizarCarrito(arrayDeProductos) {
    ...
    botonVaciarCarrito.addEventListener('click', event => {
        /*  vaciarCarrito(arrCarrito, productos)*/
        vaciarCarrito()
    })
...
/*let productosCarritoLs
let productosEnLs*/

function vaciarCarrito() {


    /* productosCarritoLs = JSON.parse(localStorage.getItem("carrito1"))
     productosEnLs = JSON.parse(localStorage.getItem("productos1"))*/
    ...
    for (const productoEnLs1 of productosCarritoLs) {
        ...
        /*productosEnLs = regresarCantidad(idProducto, cantidadProducto)*/
        regresarCantidad(idProducto, cantidadProducto)
    }

    /* actualizaLs("productos1", productosEnLs)*/

    /* localStorage.setItem("productos1", JSON.stringify(productosEnLs))*/
...
function eliminarDeCarrito(e2) {
    ...
    if (consultaCarrito.length == 1) {
        ...
        /* console.log(consultaCarrito[1].cantidad)*/
    }
